"""Training utilities for Super_Resolution.

This module avoids importing the legacy CamelCase Library and keeps runtime
dependencies local to functions that actually need them.
"""
import time
import numpy as np
